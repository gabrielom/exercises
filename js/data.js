...
// (img/gen/<id>.webp) — there is deliberately no way to create exercises in the app.
...
export const EXERCISES = [
  ...
  { id: 'pec-deck',                cat: 'gym', group: 'a', name: 'Pec Deck Fly',                 pt: 'Peitoral Dorsal',           weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'chest-press',             cat: 'gym', group: 'a', name: 'Chest Press Machine',          pt: 'Chest Press',               weight: 50,  mode: 'reps', target: 30, sets: 3 },
  { id: 'bench-press-flat',        cat: 'gym', group: 'a', name: 'Flat Bench Press',             pt: 'Supino Reto',               weight: 28,  mode: 'reps', target: 30, sets: 3 },
  { id: 'bench-press-decline',     cat: 'gym', group: 'a', name: 'Decline Bench Press',          pt: 'Supino Declinado',          weight: 28,  mode: 'reps', target: 30, sets: 3 },
  { id: 'bench-press-incline',     cat: 'gym', group: 'a', name: 'Incline Bench Press',          pt: 'Supino Inclinado',          weight: 28,  mode: 'reps', target: 30, sets: 3 },
  { id: 'triceps-pushdown',        cat: 'gym', group: 'a', name: 'Triceps Pushdown',             pt: 'Tríceps Juntado Cross',     weight: 35,  mode: 'reps', target: 30, sets: 3 },
  { id: 'triceps-pushdown-single', cat: 'gym', group: 'a', name: 'Single-arm Pushdown',          pt: 'Tríceps Unilateral Cross',  weight: 15,  mode: 'reps', target: 30, sets: 3, side: true },

  // ═══════════════ GYM · Série B — legs & core ═══════════════
  { id: 'leg-extension-cable',     cat: 'gym', group: 'b', name: 'Cable Leg Extension',          pt: 'Extensor Cross',            weight: 25,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'leg-extension-ankle',     cat: 'gym', group: 'b', name: 'Ankle-weight Extension',       pt: 'Extensor Caneleira',        weight: 7,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'leg-curl-lying',          cat: 'gym', group: 'b', name: 'Lying Leg Curl',               pt: 'Flexor Deitado',            weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'leg-curl-standing',       cat: 'gym', group: 'b', name: 'Standing Leg Curl',            pt: 'Flexor em Pé',              weight: 20,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'hip-abductor',            cat: 'gym', group: 'b', name: 'Hip Abductor Machine',         pt: 'Abdutor',                   weight: 75,  mode: 'reps', target: 30, sets: 3 },
  { id: 'hip-adductor',            cat: 'gym', group: 'b', name: 'Hip Adductor Machine',         pt: 'Adutor',                    weight: 75,  mode: 'reps', target: 30, sets: 3 },
  { id: 'side-leg-raise',          cat: 'gym', group: 'b', name: 'Ankle-weight Side Raise',      pt: 'Abdutor Caneleira',         weight: 7,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'inner-thigh-raise',       cat: 'gym', group: 'b', name: 'Ankle-weight Inner Raise',     pt: 'Adutor Caneleira',          weight: 7,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'ab-machine',              cat: 'gym', group: 'b', name: 'Ab Crunch Machine',            pt: 'Abdominal Máquina Bola',    weight: 70,  mode: 'reps', target: 30, sets: 3 },

  // ═══════════════ GYM · Série C — back & biceps ═══════════════
  { id: 'row-horizontal-machine',  cat: 'gym', group: 'c', name: 'Horizontal Pull Machine',      pt: 'Puxador Horizontal',        weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'lat-pulldown-underhand',  cat: 'gym', group: 'c', name: 'Underhand Lat Pulldown',       pt: 'Puxador Vertical Supinada', weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'seated-row-high',         cat: 'gym', group: 'c', name: 'Seated Row · High',            pt: 'Remada Sentado Cima',       weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'seated-row-mid',          cat: 'gym', group: 'c', name: 'Seated Row · Mid',             pt: 'Remada Sentado Médio',      weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'seated-row-low',          cat: 'gym', group: 'c', name: 'Seated Row · Low',             pt: 'Remada Sentado Baixo',      weight: 40,  mode: 'reps', target: 30, sets: 3 },
  { id: 'preacher-curl',           cat: 'gym', group: 'c', name: 'Preacher Curl',                pt: 'Rosca Scott',               weight: 20,  mode: 'reps', target: 30, sets: 3 },
  { id: 'cable-curl-single',       cat: 'gym', group: 'c', name: 'Single-arm Cable Curl',        pt: 'Rosca Unilateral Cross',    weight: 10,  mode: 'reps', target: 30, sets: 3, side: true },

  // ═══════════════ GYM · Série D — legs & glutes ═══════════════
  { id: 'leg-press-90',            cat: 'gym', group: 'd', name: 'Leg Press 90°',                pt: 'Legpress 90',               weight: 90,  mode: 'reps', target: 30, sets: 3 },
  { id: 'leg-press-45',            cat: 'gym', group: 'd', name: 'Leg Press 45°',                pt: 'Legpress 45',               weight: 160, mode: 'reps', target: 30, sets: 3 },
  { id: 'leg-press-horizontal',    cat: 'gym', group: 'd', name: 'Horizontal Leg Press',         pt: 'Legpress Horizontal',       weight: 140, mode: 'reps', target: 30, sets: 3 },
  { id: 'calf-press',              cat: 'gym', group: 'd', name: 'Calf Press on Leg Press',      pt: 'Panturrilha Legpress',      weight: 130, mode: 'reps', target: 30, sets: 3 },
  { id: 'hip-raise-step',          cat: 'gym', group: 'd', name: 'Hip Raise on Step',            pt: 'Elevação Quadril Step',     weight: 10,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'hip-raise-ball',          cat: 'gym', group: 'd', name: 'Single-leg Hip Raise (Ball)',  pt: 'Elevação Quadril Bola P.E/P.D', weight: 0, mode: 'reps', target: 30, sets: 3, side: true },

  // ═══════════════ GYM · Série E — chest & triceps (nova) ═══════════════
  { id: 'smith-bench-press',       cat: 'gym', group: 'e', name: 'Smith Machine Bench Press',   pt: 'Supino Barra Guiada',       weight: 30,  mode: 'reps', target: 30, sets: 3 },
  { id: 'dumbbell-bench-press',    cat: 'gym', group: 'e', name: 'Dumbbell Bench Press',        pt: 'Supino Dumbbell',           weight: 28,  mode: 'reps', target: 30, sets: 3 },
  { id: 'incline-dumbbell-fly',    cat: 'gym', group: 'e', name: 'Incline Dumbbell Fly',        pt: 'Crucifixo Inclinado Halteres', weight: 20, mode: 'reps', target: 30, sets: 3 },
  { id: 'crossover-single',        cat: 'gym', group: 'e', name: 'Single-arm Cable Crossover',  pt: 'Crossover Unilateral',      weight: 5,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'french-press-cable',      cat: 'gym', group: 'e', name: 'Cable French Press',          pt: 'Tríceps Francês Cross Supinado', weight: 40, mode: 'reps', target: 30, sets: 3 },
  { id: 'french-press-single',     cat: 'gym', group: 'e', name: 'Single-arm French Press',     pt: 'Tríceps Francês Unilateral', weight: 20, mode: 'reps', target: 30, sets: 3, side: true },

  // ═══════════════ GYM · Série F — legs & abs (nova) ═══════════════
  { id: 'hip-thrust',              cat: 'gym', group: 'f', name: 'Hip Thrust',                  pt: 'Elevação Pélvica',          weight: 100, mode: 'reps', target: 30, sets: 3 },
  { id: 'smith-lunge',             cat: 'gym', group: 'f', name: 'Smith Machine Lunge',         pt: 'Avanço Barra Guiada',       weight: 36,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'sumo-squat',              cat: 'gym', group: 'f', name: 'Sumo Squat',                  pt: 'Sumô',                      weight: 24,  mode: 'reps', target: 30, sets: 3 },
  { id: 'bulgarian-split-squat',   cat: 'gym', group: 'f', name: 'Bulgarian Split Squat',       pt: 'Agachamento Búlgaro',       weight: 0,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'calf-raise',              cat: 'gym', group: 'f', name: 'Calf Raise',                  pt: 'Panturrilha',               weight: 0,   mode: 'reps', target: 30, sets: 3 },
  { id: 'calf-raise-single',       cat: 'gym', group: 'f', name: 'Single-leg Calf Raise',       pt: 'Panturrilha Unilateral',    weight: 0,   mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'ab-iso-hold',             cat: 'gym', group: 'f', name: 'Plank Hold',                  pt: 'Abdominal Isometria',       weight: 0,   mode: 'time', target: 60, sets: 3 },
  { id: 'crunches',                cat: 'gym', group: 'f', name: 'Crunches',                    pt: 'Abdominal',                 weight: 0,   mode: 'reps', target: 30, sets: 3 },

  // ═══════════════ GYM · Série G — back & biceps (nova) ═══════════════
  { id: 'lat-machine',             cat: 'gym', group: 'g', name: 'Lat Pulldown Machine',        pt: 'Dorsal',                    weight: 35,  mode: 'reps', target: 30, sets: 3 },
  { id: 'lat-machine-single',      cat: 'gym', group: 'g', name: 'Single-arm Lat Pulldown',     pt: 'Dorsal Unilateral',         weight: 35,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'v-bar-pulldown',          cat: 'gym', group: 'g', name: 'V-bar Lat Pulldown',          pt: 'Puxada Vertical Triângulo', weight: 45,  mode: 'reps', target: 30, sets: 3 },
  { id: 'dumbbell-row-single',     cat: 'gym', group: 'g', name: 'Single-arm Dumbbell Row',     pt: 'Remada Unilateral Dumbbell', weight: 14, mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'rope-pulldown',           cat: 'gym', group: 'g', name: 'Rope Pulldown',               pt: 'Puxada Corda Cross',        weight: 55,  mode: 'reps', target: 30, sets: 3 },
  { id: 'curl-21s',                cat: 'gym', group: 'g', name: 'Biceps Curl · 21s',           pt: 'Rosca 21',                  weight: 16,  mode: 'reps', target: 30, sets: 3 },
  { id: 'concentration-curl',      cat: 'gym', group: 'g', name: 'Concentration Curl',          pt: 'Rosca Concentrada',         weight: 9,   mode: 'reps', target: 30, sets: 3, side: true },

  // ═══════════════ GYM · Série H — legs & lower back (nova) ═══════════════
  { id: 'leg-extension-iso',       cat: 'gym', group: 'h', name: 'Leg Extension · Iso Hold',    pt: 'Extensor Isometria',        weight: 70,  mode: 'time', target: 60, sets: 3 },
  { id: 'leg-extension-both',      cat: 'gym', group: 'h', name: 'Leg Extension · Both',        pt: 'Extensor Junto',            weight: 70,  mode: 'reps', target: 30, sets: 3 },
  { id: 'leg-extension-single',    cat: 'gym', group: 'h', name: 'Leg Extension · Single',      pt: 'Extensor Unilateral',       weight: 35,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'leg-curl-lying-single',   cat: 'gym', group: 'h', name: 'Single-leg Lying Curl',       pt: 'Flexor Unilateral Deitado', weight: 20,  mode: 'reps', target: 30, sets: 3, side: true },
  { id: 'hip-abductor-iso',        cat: 'gym', group: 'h', name: 'Hip Abductor 45° · Iso',      pt: 'Abdutor 45 / Isometria',    weight: 75,  mode: 'time', target: 60, sets: 3 },
  { id: 'hip-abductor-45',         cat: 'gym', group: 'h', name: 'Hip Abductor 45°',            pt: 'Abdutor 45',                weight: 75,  mode: 'reps', target: 30, sets: 3 },
  { id: 'hip-adductor-iso',        cat: 'gym', group: 'h', name: 'Hip Adductor 45° · Iso',      pt: 'Adutor 45 / Isometria',     weight: 70,  mode: 'time', target: 60, sets: 3 },
  { id: 'hip-adductor-45',         cat: 'gym', group: 'h', name: 'Hip Adductor 45°',            pt: 'Adutor 45',                 weight: 70,  mode: 'reps', target: 30, sets: 3 },
  { id: 'back-extension',          cat: 'gym', group: 'h', name: 'Back Extension',              pt: 'Flexão Lombar',             weight: 0,   mode: 'reps', target: 30, sets: 3 },

  // ═══════════════ PUSH & PULL-UPS ═══════════════
  { id: 'push-up',         cat: 'cal',  name: 'Push-up',         mode: 'reps', target: 10, sets: 3, cue: 'One straight line, chest to the floor' },
  { id: 'wide-push-up',    cat: 'cal',  name: 'Wide Push-up',    mode: 'reps', target: 10, sets: 3, cue: 'Hands wide, elbows at 45°' },
  { id: 'diamond-push-up', cat: 'cal',  name: 'Diamond Push-up', mode: 'reps', target: 10, sets: 3,  cue: 'Hands together under the chest' },
  { id: 'incline-push-up', cat: 'cal',  name: 'Incline Push-up', mode: 'reps', target: 10, sets: 3, cue: 'Hands elevated, body still a plank' },
  { id: 'knee-push-up',    cat: 'cal',  name: 'Knee Push-up',    mode: 'reps', target: 10, sets: 3, cue: 'Hips forward, line from knees to head' },

  { id: 'pull-up',          cat: 'cal',  name: 'Pull-up',          mode: 'reps', target: 10, sets: 3,  cue: 'Chest to bar, full hang between reps' },
  { id: 'chin-up',          cat: 'cal',  name: 'Chin-up',          mode: 'reps', target: 10, sets: 3,  cue: 'Palms toward you, lead with the chest' },
  { id: 'negative-pull-up', cat: 'cal',  name: 'Negative Pull-up', mode: 'reps', target: 10, sets: 3,  cue: 'Jump up, lower for 5 slow counts' },
  { id: 'scapular-pull',    cat: 'cal',  name: 'Scapular Pull',    mode: 'reps', target: 10, sets: 3,  cue: 'Arms straight, shrug the shoulders down' },
  { id: 'dead-hang',        cat: 'cal',  name: 'Dead Hang',        mode: 'time', target: 30, sets: 3, cue: 'Relax into the hang, breathe' },
...
// Generated illustration for every exercise (see tools/genimages.mjs).
export const imgFor = id => `img/gen/${id}.webp`;
